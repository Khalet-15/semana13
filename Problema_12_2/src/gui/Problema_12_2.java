...
public class Problema_12_2 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		Licencia l= new Licencia("ayuda","debil","12/03/03","19/12/23");
		listar(l);
		Particular pa= new Particular("nose","medio","20/09/01","14/02/20",897564);
		listar(pa);
		Profesional pr= new Profesional("aaaa","avanzado","20/09/01","19/12/23","9871320");
		listar(pr);
	}
	void listar (Licencia x){
		if (x instanceof Particular)
			imprimir(">>>  P A R T I C U L A R");
		else
			if (x instanceof Profesional)
